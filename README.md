...
If you discover any security issues, please email `geckotech1001@gmail.com` instead of creating a public Issue.

## License

Released under the [MIT](LICENSE) license. Copyright belongs to **Gecko Tech**.
